...
class SemestersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create semester" do
    assert_difference('Semester.count') do
      post semesters_url, params: { semester: { description: @semester.description, semesterid: @semester.semesterid, semestername: @semester.semestername, user_id: @semester.user_id } }
    end
  ...
  test "should update semester" do
    patch semester_url(@semester), params: { semester: { description: @semester.description, semesterid: @semester.semesterid, semestername: @semester.semestername, user_id: @semester.user_id } }
