...
class CurriculumsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create curriculum" do
    assert_difference('Curriculum.count') do
      post curriculums_url, params: { curriculum: { courseid: @curriculum.courseid, coursename: @curriculum.coursename, description: @curriculum.description, user_id: @curriculum.user_id } }
    end
  ...
  test "should update curriculum" do
    patch curriculum_url(@curriculum), params: { curriculum: { courseid: @curriculum.courseid, coursename: @curriculum.coursename, description: @curriculum.description, user_id: @curriculum.user_id } }
